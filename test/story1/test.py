...
def testSuite():
    ...
    testCsvUpload('test/story1/duplicateIdTest.csv', 400, '{"results":"Rejected due to: Duplicate Id/Login"}')
    testCsvUpload('test/story1/duplicateLoginTest.csv', 400, '{"results":"Rejected due to: Duplicate Id/Login"}')
